        ...
        <c:forEach var="product" items="${productList}">
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#staticBackdrop${product.getId()}">Detail</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Tên :${product.getName()}</p>
                                <p>Giá :${product.getPrice()}</p>
                                <p>Mô tả: ${product.getDescription()}</p>
                                <p>Nhà sản xuất: ${product.getManufacturer()}</p>
                            </div>
                            <div class="modal-footer">
